...
SIGNAL \FA0|b[5]~0_combout\ : std_logic;
SIGNAL \FA0|b[1]~1_combout\ : std_logic;
SIGNAL \FA0|b[0]~2_combout\ : std_logic;
SIGNAL \comparator~0_combout\ : std_logic;
SIGNAL \FA0|b\ : std_logic_vector(0 TO 6);
SIGNAL \FA0|ALT_INV_b[0]~2_combout\ : std_logic;
SIGNAL \FA0|ALT_INV_b[1]~1_combout\ : std_logic;
...
ww_devclrn <= devclrn;
ww_devpor <= devpor;
\FA0|ALT_INV_b[0]~2_combout\ <= NOT \FA0|b[0]~2_combout\;
\FA0|ALT_INV_b[1]~1_combout\ <= NOT \FA0|b[1]~1_combout\;
...
-- Equation(s):
-- \FA0|b\(6) = (\SW[2]~input_o\ & (!\SW[3]~input_o\ & (\SW[0]~input_o\ & \SW[1]~input_o\))) # (!\SW[2]~input_o\ & (\SW[3]~input_o\ $ (((!\SW[1]~input_o\)))))
...
\FA0|b[5]~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \FA0|b[5]~0_combout\ = (\SW[3]~input_o\ & ((\SW[2]~input_o\ & ((!\SW[1]~input_o\))) # (!\SW[2]~input_o\ & (\SW[0]~input_o\ & \SW[1]~input_o\)))) # (!\SW[3]~input_o\ & ((\SW[0]~input_o\ & ((\SW[1]~input_o\) # (!\SW[2]~input_o\))) # (!\SW[0]~input_o\ & 
...
PORT MAP (
	...
	datac => \SW[2]~input_o\,
	datad => \SW[1]~input_o\,
	combout => \FA0|b[5]~0_combout\);

-- Location: LCCOMB_X47_Y90_N20
\FA0|b[4]\ : cycloneiv_lcell_comb
-- Equation(s):
-- \FA0|b\(4) = (\SW[0]~input_o\) # ((\SW[2]~input_o\ & (\SW[3]~input_o\ $ (!\SW[1]~input_o\))))
...
-- Equation(s):
-- \FA0|b\(3) = (\SW[0]~input_o\ & (\SW[2]~input_o\ $ (((\SW[3]~input_o\) # (!\SW[1]~input_o\))))) # (!\SW[0]~input_o\ & (\SW[2]~input_o\ & (\SW[3]~input_o\ $ (!\SW[1]~input_o\))))
...
-- Equation(s):
-- \FA0|b\(2) = (!\SW[0]~input_o\ & ((\SW[3]~input_o\ & (\SW[2]~input_o\ & !\SW[1]~input_o\)) # (!\SW[3]~input_o\ & (!\SW[2]~input_o\ & \SW[1]~input_o\))))
...
\FA0|b[1]~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \FA0|b[1]~1_combout\ = ((\SW[3]~input_o\ & ((!\SW[1]~input_o\) # (!\SW[0]~input_o\))) # (!\SW[3]~input_o\ & (\SW[0]~input_o\ $ (!\SW[1]~input_o\)))) # (!\SW[2]~input_o\)
...
PORT MAP (
	...
	datac => \SW[2]~input_o\,
	datad => \SW[1]~input_o\,
	combout => \FA0|b[1]~1_combout\);

-- Location: LCCOMB_X47_Y90_N12
\FA0|b[0]~2\ : cycloneiv_lcell_comb
-- Equation(s):
-- \FA0|b[0]~2_combout\ = (\SW[3]~input_o\ & ((\SW[0]~input_o\ $ (!\SW[2]~input_o\)) # (!\SW[1]~input_o\))) # (!\SW[3]~input_o\ & ((\SW[1]~input_o\) # (\SW[0]~input_o\ $ (!\SW[2]~input_o\))))
...
PORT MAP (
	...
	datac => \SW[2]~input_o\,
	datad => \SW[1]~input_o\,
	combout => \FA0|b[0]~2_combout\);

-- Location: LCCOMB_X47_Y90_N30
\comparator~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \comparator~0_combout\ = (\SW[3]~input_o\ & ((\SW[2]~input_o\) # (\SW[1]~input_o\)))
