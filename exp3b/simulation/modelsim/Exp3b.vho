...
-- Equation(s):
-- \HeMan|R_g~combout\ = LCELL((!\SW[1]~input_o\) # (!\HeMan|R~combout\))
...
-- Equation(s):
-- \HeMan|Qb~combout\ = LCELL((!\HeMan|Qa~combout\) # (!\HeMan|R_g~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \HeMan|R_g~combout\,
	datad => \HeMan|Qa~combout\,
	combout => \HeMan|Qb~combout\);

-- Location: LCCOMB_X116_Y42_N2
\HeMan|S_g\ : cycloneiv_lcell_comb
-- Equation(s):
-- \HeMan|S_g~combout\ = LCELL((!\SW[1]~input_o\) # (!\SW[0]~input_o\))
