...
ARCHITECTURE structure OF Exp6a IS
...
SIGNAL \A4|Overflow~0_combout\ : std_logic;
...
\A0|Qvar[0]~feeder\ : cycloneiv_lcell_comb
-- Equation(s):
-- \A0|Qvar[0]~feeder_combout\ = \SW[0]~input_o\
...
PORT MAP (
	datad => \SW[0]~input_o\,
	combout => \A0|Qvar[0]~feeder_combout\);
...
\A4|Add0~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \A4|Add0~0_combout\ = (\A0|Qvar\(0) & (\A1|Qvar\(0) $ (VCC))) # (!\A0|Qvar\(0) & (\A1|Qvar\(0) & VCC))
-- \A4|Add0~1\ = CARRY((\A0|Qvar\(0) & \A1|Qvar\(0)))
...
\A0|Qvar[1]~feeder\ : cycloneiv_lcell_comb
-- Equation(s):
-- \A0|Qvar[1]~feeder_combout\ = \SW[1]~input_o\
...
PORT MAP (
	datad => \SW[1]~input_o\,
	combout => \A0|Qvar[1]~feeder_combout\);

-- Location: FF_X116_Y42_N31
\A0|Qvar[1]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
...
-- Equation(s):
-- \A4|Add0~2_combout\ = (\A0|Qvar\(1) & ((\A1|Qvar\(1) & (\A4|Add0~1\ & VCC)) # (!\A1|Qvar\(1) & (!\A4|Add0~1\)))) # (!\A0|Qvar\(1) & ((\A1|Qvar\(1) & (!\A4|Add0~1\)) # (!\A1|Qvar\(1) & ((\A4|Add0~1\) # (GND)))))
-- \A4|Add0~3\ = CARRY((\A0|Qvar\(1) & (!\A1|Qvar\(1) & !\A4|Add0~1\)) # (!\A0|Qvar\(1) & ((!\A4|Add0~1\) # (!\A1|Qvar\(1)))))
...
-- Equation(s):
-- \A4|Add0~4_combout\ = ((\A0|Qvar\(2) $ (\A1|Qvar\(2) $ (!\A4|Add0~3\)))) # (GND)
-- \A4|Add0~5\ = CARRY((\A0|Qvar\(2) & ((\A1|Qvar\(2)) # (!\A4|Add0~3\))) # (!\A0|Qvar\(2) & (\A1|Qvar\(2) & !\A4|Add0~3\)))
...
\A0|Qvar[3]~feeder\ : cycloneiv_lcell_comb
-- Equation(s):
-- \A0|Qvar[3]~feeder_combout\ = \SW[3]~input_o\
...
PORT MAP (
	datad => \SW[3]~input_o\,
	combout => \A0|Qvar[3]~feeder_combout\);
...
-- Equation(s):
-- \A4|Add0~6_combout\ = (\A0|Qvar\(3) & ((\A1|Qvar\(3) & (\A4|Add0~5\ & VCC)) # (!\A1|Qvar\(3) & (!\A4|Add0~5\)))) # (!\A0|Qvar\(3) & ((\A1|Qvar\(3) & (!\A4|Add0~5\)) # (!\A1|Qvar\(3) & ((\A4|Add0~5\) # (GND)))))
-- \A4|Add0~7\ = CARRY((\A0|Qvar\(3) & (!\A1|Qvar\(3) & !\A4|Add0~5\)) # (!\A0|Qvar\(3) & ((!\A4|Add0~5\) # (!\A1|Qvar\(3)))))
...
\A0|Qvar[4]~feeder\ : cycloneiv_lcell_comb
-- Equation(s):
-- \A0|Qvar[4]~feeder_combout\ = \SW[4]~input_o\
...
PORT MAP (
	datad => \SW[4]~input_o\,
	combout => \A0|Qvar[4]~feeder_combout\);
...
-- Equation(s):
-- \A4|Add0~8_combout\ = ((\A0|Qvar\(4) $ (\A1|Qvar\(4) $ (!\A4|Add0~7\)))) # (GND)
-- \A4|Add0~9\ = CARRY((\A0|Qvar\(4) & ((\A1|Qvar\(4)) # (!\A4|Add0~7\))) # (!\A0|Qvar\(4) & (\A1|Qvar\(4) & !\A4|Add0~7\)))
...
\A0|Qvar[5]~feeder\ : cycloneiv_lcell_comb
-- Equation(s):
-- \A0|Qvar[5]~feeder_combout\ = \SW[5]~input_o\
...
PORT MAP (
	datad => \SW[5]~input_o\,
	combout => \A0|Qvar[5]~feeder_combout\);
...
-- Equation(s):
-- \A4|Add0~10_combout\ = (\A1|Qvar\(5) & ((\A0|Qvar\(5) & (\A4|Add0~9\ & VCC)) # (!\A0|Qvar\(5) & (!\A4|Add0~9\)))) # (!\A1|Qvar\(5) & ((\A0|Qvar\(5) & (!\A4|Add0~9\)) # (!\A0|Qvar\(5) & ((\A4|Add0~9\) # (GND)))))
-- \A4|Add0~11\ = CARRY((\A1|Qvar\(5) & (!\A0|Qvar\(5) & !\A4|Add0~9\)) # (!\A1|Qvar\(5) & ((!\A4|Add0~9\) # (!\A0|Qvar\(5)))))
...
\A0|Qvar[6]~feeder\ : cycloneiv_lcell_comb
-- Equation(s):
-- \A0|Qvar[6]~feeder_combout\ = \SW[6]~input_o\
...
PORT MAP (
	datad => \SW[6]~input_o\,
	combout => \A0|Qvar[6]~feeder_combout\);
...
-- Equation(s):
-- \A4|Add0~12_combout\ = ((\A0|Qvar\(6) $ (\A1|Qvar\(6) $ (!\A4|Add0~11\)))) # (GND)
-- \A4|Add0~13\ = CARRY((\A0|Qvar\(6) & ((\A1|Qvar\(6)) # (!\A4|Add0~11\))) # (!\A0|Qvar\(6) & (\A1|Qvar\(6) & !\A4|Add0~11\)))
...
\A0|Qvar[7]~feeder\ : cycloneiv_lcell_comb
-- Equation(s):
-- \A0|Qvar[7]~feeder_combout\ = \SW[7]~input_o\
...
PORT MAP (
	datad => \SW[7]~input_o\,
	combout => \A0|Qvar[7]~feeder_combout\);
...
PORT MAP (
	clk => \KEY[1]~input_o\,
	d => \A0|Qvar[7]~feeder_combout\,
	clrn => \KEY[0]~input_o\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \A0|Qvar\(7));

-- Location: LCCOMB_X116_Y42_N14
\A4|Add0~14\ : cycloneiv_lcell_comb
-- Equation(s):
-- \A4|Add0~14_combout\ = (\A1|Qvar\(7) & ((\A0|Qvar\(7) & (\A4|Add0~13\ & VCC)) # (!\A0|Qvar\(7) & (!\A4|Add0~13\)))) # (!\A1|Qvar\(7) & ((\A0|Qvar\(7) & (!\A4|Add0~13\)) # (!\A0|Qvar\(7) & ((\A4|Add0~13\) # (GND)))))
-- \A4|Add0~15\ = CARRY((\A1|Qvar\(7) & (!\A0|Qvar\(7) & !\A4|Add0~13\)) # (!\A1|Qvar\(7) & ((!\A4|Add0~13\) # (!\A0|Qvar\(7)))))
...
\A4|Overflow~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \A4|Overflow~0_combout\ = (\A1|Qvar\(7) & (!\A4|Add0~14_combout\ & \A0|Qvar\(7))) # (!\A1|Qvar\(7) & (\A4|Add0~14_combout\ & !\A0|Qvar\(7)))
...
PORT MAP (
	dataa => \A1|Qvar\(7),
	datac => \A4|Add0~14_combout\,
	datad => \A0|Qvar\(7),
	combout => \A4|Overflow~0_combout\);
