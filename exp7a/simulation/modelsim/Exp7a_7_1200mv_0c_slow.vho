...
ARCHITECTURE structure OF Exp7a IS
...
SIGNAL \A00|Qvar[0]~feeder_combout\ : std_logic;
SIGNAL \KEY[1]~input_o\ : std_logic;
SIGNAL \SW[0]~input_o\ : std_logic;
SIGNAL \X[4]~2_combout\ : std_logic;
SIGNAL \X[5]~3_combout\ : std_logic;
SIGNAL \X[5]~4_combout\ : std_logic;
SIGNAL \X[8]~5_combout\ : std_logic;
SIGNAL \X[1]~0_combout\ : std_logic;
SIGNAL \X[1]~1_combout\ : std_logic;
SIGNAL \Z~0_combout\ : std_logic;
SIGNAL \A08|Qvar\ : std_logic_vector(0 DOWNTO 0);
SIGNAL \A05|Qvar\ : std_logic_vector(0 DOWNTO 0);
SIGNAL \A00|Qvar\ : std_logic_vector(0 DOWNTO 0);
SIGNAL \A07|Qvar\ : std_logic_vector(0 DOWNTO 0);
SIGNAL \A02|Qvar\ : std_logic_vector(0 DOWNTO 0);
SIGNAL \A06|Qvar\ : std_logic_vector(0 DOWNTO 0);
SIGNAL \A01|Qvar\ : std_logic_vector(0 DOWNTO 0);
SIGNAL X : std_logic_vector(8 DOWNTO 0);
SIGNAL \A03|Qvar\ : std_logic_vector(0 DOWNTO 0);
SIGNAL \A04|Qvar\ : std_logic_vector(0 DOWNTO 0);
...
-- Location: LCCOMB_X116_Y34_N4
\A00|Qvar[0]~feeder\ : cycloneiv_lcell_comb
-- Equation(s):
-- \A00|Qvar[0]~feeder_combout\ = VCC
...
-- pragma translate_on
PORT MAP (
	combout => \A00|Qvar[0]~feeder_combout\);
...
-- Location: LCCOMB_X116_Y34_N28
\X[2]\ : cycloneiv_lcell_comb
-- Equation(s):
-- X(2) = (!\SW[0]~input_o\ & \A01|Qvar\(0))
...
-- Location: LCCOMB_X116_Y34_N26
\X[3]\ : cycloneiv_lcell_comb
-- Equation(s):
-- X(3) = (!\SW[0]~input_o\ & \A02|Qvar\(0))
...
-- Location: LCCOMB_X116_Y34_N20
\X[4]~2\ : cycloneiv_lcell_comb
-- Equation(s):
-- \X[4]~2_combout\ = (!\SW[0]~input_o\ & ((\A04|Qvar\(0)) # (\A03|Qvar\(0))))
...
-- Location: LCCOMB_X116_Y34_N10
\X[5]~3\ : cycloneiv_lcell_comb
-- Equation(s):
-- \X[5]~3_combout\ = (\A03|Qvar\(0)) # ((\A01|Qvar\(0)) # ((\A04|Qvar\(0)) # (!\A00|Qvar\(0))))
...
-- Location: LCCOMB_X116_Y34_N22
\X[5]~4\ : cycloneiv_lcell_comb
-- Equation(s):
-- \X[5]~4_combout\ = (\SW[0]~input_o\ & ((\A02|Qvar\(0)) # (\X[5]~3_combout\)))
...
PORT MAP (
	...
	datac => \SW[0]~input_o\,
	datad => \X[5]~3_combout\,
	combout => \X[5]~4_combout\);

-- Location: FF_X116_Y34_N23
\A05|Qvar[0]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
...
-- Location: LCCOMB_X116_Y34_N0
\X[6]\ : cycloneiv_lcell_comb
-- Equation(s):
-- X(6) = (\A05|Qvar\(0) & \SW[0]~input_o\)
...
-- Location: LCCOMB_X116_Y34_N18
\X[7]\ : cycloneiv_lcell_comb
-- Equation(s):
-- X(7) = (\SW[0]~input_o\ & \A06|Qvar\(0))
...
-- Location: LCCOMB_X116_Y34_N12
\X[8]~5\ : cycloneiv_lcell_comb
-- Equation(s):
-- \X[8]~5_combout\ = (\SW[0]~input_o\ & ((\A08|Qvar\(0)) # (\A07|Qvar\(0))))
...
PORT MAP (
	...
	datac => \A08|Qvar\(0),
	datad => \A07|Qvar\(0),
	combout => \X[8]~5_combout\);

-- Location: FF_X116_Y34_N13
\A08|Qvar[0]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
...
-- Location: LCCOMB_X116_Y34_N24
\X[1]~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \X[1]~0_combout\ = (\A05|Qvar\(0)) # ((\A07|Qvar\(0)) # ((\A08|Qvar\(0)) # (!\A00|Qvar\(0))))
...
-- Location: LCCOMB_X116_Y34_N14
\X[1]~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \X[1]~1_combout\ = (!\SW[0]~input_o\ & ((\A06|Qvar\(0)) # (\X[1]~0_combout\)))
...
-- Location: LCCOMB_X116_Y34_N30
\Z~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \Z~0_combout\ = (\A04|Qvar\(0)) # (\A08|Qvar\(0))
