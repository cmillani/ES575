...
ARCHITECTURE structure OF exp4a IS
...
SIGNAL \B01|A01|Qvar~0_combout\ : std_logic;
SIGNAL \KEY[1]~input_o\ : std_logic;
SIGNAL \B01|A01|Qvar~q\ : std_logic;
SIGNAL \B01|A02|Qvar~0_combout\ : std_logic;
SIGNAL \B01|A02|Qvar~q\ : std_logic;
SIGNAL \B01|A03|Qvar~0_combout\ : std_logic;
SIGNAL \B01|A03|Qvar~q\ : std_logic;
SIGNAL \B01|A04|Qvar~0_combout\ : std_logic;
SIGNAL \B01|A04|Qvar~q\ : std_logic;
...
SIGNAL \B01|A05|Qvar~0_combout\ : std_logic;
SIGNAL \B01|A05|Qvar~q\ : std_logic;
SIGNAL \B01|A06|Qvar~0_combout\ : std_logic;
SIGNAL \B01|A06|Qvar~q\ : std_logic;
SIGNAL \B01|A07|Qvar~0_combout\ : std_logic;
SIGNAL \B01|A07|Qvar~q\ : std_logic;
SIGNAL \B01|A08|Qvar~0_combout\ : std_logic;
SIGNAL \B01|A08|Qvar~1_combout\ : std_logic;
SIGNAL \B01|A08|Qvar~q\ : std_logic;
...
SIGNAL \B01|Andy\ : std_logic_vector(6 DOWNTO 0);
...
\B01|A01|Qvar~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \B01|A01|Qvar~0_combout\ = \KEY[2]~input_o\ $ (\B01|A01|Qvar~q\)
...
PORT MAP (
	dataa => \KEY[2]~input_o\,
	datac => \B01|A01|Qvar~q\,
	combout => \B01|A01|Qvar~0_combout\);
...
\B01|A02|Qvar~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \B01|A02|Qvar~0_combout\ = \B01|A02|Qvar~q\ $ (((\KEY[2]~input_o\ & \B01|A01|Qvar~q\)))
...
PORT MAP (
	dataa => \KEY[2]~input_o\,
	datac => \B01|A02|Qvar~q\,
	datad => \B01|A01|Qvar~q\,
	combout => \B01|A02|Qvar~0_combout\);
...
\B01|A03|Qvar~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \B01|A03|Qvar~0_combout\ = \B01|A03|Qvar~q\ $ (((\B01|A01|Qvar~q\ & (\KEY[2]~input_o\ & \B01|A02|Qvar~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \B01|A01|Qvar~q\,
	datab => \KEY[2]~input_o\,
	datac => \B01|A03|Qvar~q\,
	datad => \B01|A02|Qvar~q\,
	combout => \B01|A03|Qvar~0_combout\);
...
\B01|Andy[2]\ : cycloneiv_lcell_comb
-- Equation(s):
-- \B01|Andy\(2) = (\KEY[2]~input_o\ & (\B01|A01|Qvar~q\ & (\B01|A02|Qvar~q\ & \B01|A03|Qvar~q\)))
...
PORT MAP (
	dataa => \KEY[2]~input_o\,
	datab => \B01|A01|Qvar~q\,
	datac => \B01|A02|Qvar~q\,
	datad => \B01|A03|Qvar~q\,
	combout => \B01|Andy\(2));

-- Location: LCCOMB_X116_Y44_N18
\B01|A04|Qvar~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \B01|A04|Qvar~0_combout\ = \B01|A04|Qvar~q\ $ (\B01|Andy\(2))
...
-- pragma translate_on
PORT MAP (
	datac => \B01|A04|Qvar~q\,
	datad => \B01|Andy\(2),
	combout => \B01|A04|Qvar~0_combout\);
...
-- Equation(s):
-- \B02|Mux6~0_combout\ = (\B01|A01|Qvar~q\ & ((\B01|A04|Qvar~q\) # (\B01|A03|Qvar~q\ $ (\B01|A02|Qvar~q\)))) # (!\B01|A01|Qvar~q\ & ((\B01|A02|Qvar~q\) # (\B01|A04|Qvar~q\ $ (\B01|A03|Qvar~q\))))
...
-- Equation(s):
-- \B02|Mux5~0_combout\ = (\B01|A01|Qvar~q\ & (\B01|A04|Qvar~q\ $ (((\B01|A02|Qvar~q\) # (!\B01|A03|Qvar~q\))))) # (!\B01|A01|Qvar~q\ & (!\B01|A04|Qvar~q\ & (!\B01|A03|Qvar~q\ & \B01|A02|Qvar~q\)))
...
-- Equation(s):
-- \B02|Mux4~0_combout\ = (\B01|A02|Qvar~q\ & (\B01|A01|Qvar~q\ & (!\B01|A04|Qvar~q\))) # (!\B01|A02|Qvar~q\ & ((\B01|A03|Qvar~q\ & ((!\B01|A04|Qvar~q\))) # (!\B01|A03|Qvar~q\ & (\B01|A01|Qvar~q\))))
...
-- Equation(s):
-- \B02|Mux3~0_combout\ = (\B01|A01|Qvar~q\ & (\B01|A03|Qvar~q\ $ ((!\B01|A02|Qvar~q\)))) # (!\B01|A01|Qvar~q\ & ((\B01|A03|Qvar~q\ & (!\B01|A02|Qvar~q\ & !\B01|A04|Qvar~q\)) # (!\B01|A03|Qvar~q\ & (\B01|A02|Qvar~q\ & \B01|A04|Qvar~q\))))
...
PORT MAP (
	dataa => \B01|A01|Qvar~q\,
	datab => \B01|A03|Qvar~q\,
	datac => \B01|A02|Qvar~q\,
	datad => \B01|A04|Qvar~q\,
	combout => \B02|Mux3~0_combout\);

-- Location: LCCOMB_X116_Y43_N6
\B02|Mux2~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \B02|Mux2~0_combout\ = (\B01|A03|Qvar~q\ & (\B01|A04|Qvar~q\ & ((\B01|A02|Qvar~q\) # (!\B01|A01|Qvar~q\)))) # (!\B01|A03|Qvar~q\ & (!\B01|A01|Qvar~q\ & (\B01|A02|Qvar~q\ & !\B01|A04|Qvar~q\)))
...
-- Equation(s):
-- \B02|Mux1~0_combout\ = (\B01|A04|Qvar~q\ & ((\B01|A01|Qvar~q\ & ((\B01|A02|Qvar~q\))) # (!\B01|A01|Qvar~q\ & (\B01|A03|Qvar~q\)))) # (!\B01|A04|Qvar~q\ & (\B01|A03|Qvar~q\ & (\B01|A01|Qvar~q\ $ (\B01|A02|Qvar~q\))))
...
-- Equation(s):
-- \B02|Mux0~0_combout\ = (\B01|A04|Qvar~q\ & (\B01|A01|Qvar~q\ & (\B01|A03|Qvar~q\ $ (\B01|A02|Qvar~q\)))) # (!\B01|A04|Qvar~q\ & (!\B01|A02|Qvar~q\ & (\B01|A01|Qvar~q\ $ (\B01|A03|Qvar~q\))))
...
\B01|A05|Qvar~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \B01|A05|Qvar~0_combout\ = \B01|A05|Qvar~q\ $ (((\B01|A04|Qvar~q\ & \B01|Andy\(2))))
...
PORT MAP (
	datab => \B01|A04|Qvar~q\,
	datac => \B01|A05|Qvar~q\,
	datad => \B01|Andy\(2),
	combout => \B01|A05|Qvar~0_combout\);
...
\B01|A06|Qvar~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \B01|A06|Qvar~0_combout\ = \B01|A06|Qvar~q\ $ (((\B01|A05|Qvar~q\ & (\B01|A04|Qvar~q\ & \B01|Andy\(2)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \B01|A05|Qvar~q\,
	datab => \B01|A04|Qvar~q\,
	datac => \B01|A06|Qvar~q\,
	datad => \B01|Andy\(2),
	combout => \B01|A06|Qvar~0_combout\);
...
\B01|Andy[5]\ : cycloneiv_lcell_comb
-- Equation(s):
-- \B01|Andy\(5) = (\B01|A05|Qvar~q\ & (\B01|A04|Qvar~q\ & (\B01|A06|Qvar~q\ & \B01|Andy\(2))))
...
\B01|A07|Qvar~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \B01|A07|Qvar~0_combout\ = \B01|A07|Qvar~q\ $ (\B01|Andy\(5))
...
-- pragma translate_on
PORT MAP (
	datac => \B01|A07|Qvar~q\,
	datad => \B01|Andy\(5),
	combout => \B01|A07|Qvar~0_combout\);
...
\B01|A08|Qvar~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \B01|A08|Qvar~0_combout\ = ((!\B01|A04|Qvar~q\) # (!\B01|A05|Qvar~q\)) # (!\B01|A06|Qvar~q\)
...
-- pragma translate_on
PORT MAP (
	datab => \B01|A06|Qvar~q\,
	datac => \B01|A05|Qvar~q\,
	datad => \B01|A04|Qvar~q\,
	combout => \B01|A08|Qvar~0_combout\);

-- Location: LCCOMB_X116_Y44_N0
\B01|A08|Qvar~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \B01|A08|Qvar~1_combout\ = \B01|A08|Qvar~q\ $ (((!\B01|A08|Qvar~0_combout\ & (\B01|A07|Qvar~q\ & \B01|Andy\(2)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \B01|A08|Qvar~0_combout\,
	datab => \B01|A07|Qvar~q\,
	datac => \B01|A08|Qvar~q\,
	datad => \B01|Andy\(2),
	combout => \B01|A08|Qvar~1_combout\);
...
-- Equation(s):
-- \B03|Mux6~0_combout\ = (\B01|A05|Qvar~q\ & ((\B01|A08|Qvar~q\) # (\B01|A06|Qvar~q\ $ (\B01|A07|Qvar~q\)))) # (!\B01|A05|Qvar~q\ & ((\B01|A06|Qvar~q\) # (\B01|A07|Qvar~q\ $ (\B01|A08|Qvar~q\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \B01|A06|Qvar~q\,
	datab => \B01|A07|Qvar~q\,
	datac => \B01|A05|Qvar~q\,
	datad => \B01|A08|Qvar~q\,
	combout => \B03|Mux6~0_combout\);

-- Location: LCCOMB_X50_Y87_N10
\B03|Mux5~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \B03|Mux5~0_combout\ = (\B01|A06|Qvar~q\ & (!\B01|A08|Qvar~q\ & ((\B01|A05|Qvar~q\) # (!\B01|A07|Qvar~q\)))) # (!\B01|A06|Qvar~q\ & (\B01|A05|Qvar~q\ & (\B01|A07|Qvar~q\ $ (!\B01|A08|Qvar~q\))))
...
-- Equation(s):
-- \B03|Mux4~0_combout\ = (\B01|A06|Qvar~q\ & (((\B01|A05|Qvar~q\ & !\B01|A08|Qvar~q\)))) # (!\B01|A06|Qvar~q\ & ((\B01|A07|Qvar~q\ & ((!\B01|A08|Qvar~q\))) # (!\B01|A07|Qvar~q\ & (\B01|A05|Qvar~q\))))
...
-- Equation(s):
-- \B03|Mux3~0_combout\ = (\B01|A05|Qvar~q\ & (\B01|A06|Qvar~q\ $ ((!\B01|A07|Qvar~q\)))) # (!\B01|A05|Qvar~q\ & ((\B01|A06|Qvar~q\ & (!\B01|A07|Qvar~q\ & \B01|A08|Qvar~q\)) # (!\B01|A06|Qvar~q\ & (\B01|A07|Qvar~q\ & !\B01|A08|Qvar~q\))))
...
-- Equation(s):
-- \B03|Mux2~0_combout\ = (\B01|A07|Qvar~q\ & (\B01|A08|Qvar~q\ & ((\B01|A06|Qvar~q\) # (!\B01|A05|Qvar~q\)))) # (!\B01|A07|Qvar~q\ & (\B01|A06|Qvar~q\ & (!\B01|A05|Qvar~q\ & !\B01|A08|Qvar~q\)))
...
-- Equation(s):
-- \B03|Mux1~0_combout\ = (\B01|A06|Qvar~q\ & ((\B01|A05|Qvar~q\ & ((\B01|A08|Qvar~q\))) # (!\B01|A05|Qvar~q\ & (\B01|A07|Qvar~q\)))) # (!\B01|A06|Qvar~q\ & (\B01|A07|Qvar~q\ & (\B01|A05|Qvar~q\ $ (\B01|A08|Qvar~q\))))
...
-- Equation(s):
-- \B03|Mux0~0_combout\ = (\B01|A07|Qvar~q\ & (!\B01|A06|Qvar~q\ & (\B01|A05|Qvar~q\ $ (!\B01|A08|Qvar~q\)))) # (!\B01|A07|Qvar~q\ & (\B01|A05|Qvar~q\ & (\B01|A06|Qvar~q\ $ (!\B01|A08|Qvar~q\))))
