...
SIGNAL \HeMan|R~combout\ : std_logic;
SIGNAL \KEY[3]~input_o\ : std_logic;
SIGNAL \HeMan|R_g~combout\ : std_logic;
SIGNAL \HeMan|Qb~combout\ : std_logic;
SIGNAL \HeMan|S_g~combout\ : std_logic;
SIGNAL \HeMan|Qa~combout\ : std_logic;
SIGNAL \SheRa|S_g~combout\ : std_logic;
SIGNAL \SheRa|R~combout\ : std_logic;
SIGNAL \SheRa|R_g~combout\ : std_logic;
SIGNAL \SheRa|Qb~combout\ : std_logic;
SIGNAL \SheRa|Qa~combout\ : std_logic;
...
\HeMan|R\ : cycloneiv_lcell_comb
-- Equation(s):
-- \HeMan|R~combout\ = LCELL(!\SW[0]~input_o\)
...
\HeMan|R_g\ : cycloneiv_lcell_comb
-- Equation(s):
-- \HeMan|R_g~combout\ = LCELL((\KEY[3]~input_o\) # (!\HeMan|R~combout\))
...
-- pragma translate_on
PORT MAP (
	datac => \HeMan|R~combout\,
	datad => \KEY[3]~input_o\,
	combout => \HeMan|R_g~combout\);

-- Location: LCCOMB_X116_Y39_N20
\HeMan|Qb\ : cycloneiv_lcell_comb
-- Equation(s):
-- \HeMan|Qb~combout\ = LCELL((!\HeMan|R_g~combout\) # (!\HeMan|Qa~combout\))
...
-- pragma translate_on
PORT MAP (
	datac => \HeMan|Qa~combout\,
	datad => \HeMan|R_g~combout\,
	combout => \HeMan|Qb~combout\);

-- Location: LCCOMB_X116_Y39_N2
\HeMan|S_g\ : cycloneiv_lcell_comb
-- Equation(s):
-- \HeMan|S_g~combout\ = LCELL((\KEY[3]~input_o\) # (!\SW[0]~input_o\))
...
PORT MAP (
	dataa => \KEY[3]~input_o\,
	datad => \SW[0]~input_o\,
	combout => \HeMan|S_g~combout\);

-- Location: LCCOMB_X116_Y39_N22
\HeMan|Qa\ : cycloneiv_lcell_comb
-- Equation(s):
-- \HeMan|Qa~combout\ = LCELL((!\HeMan|S_g~combout\) # (!\HeMan|Qb~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \HeMan|Qb~combout\,
	datad => \HeMan|S_g~combout\,
	combout => \HeMan|Qa~combout\);

-- Location: LCCOMB_X116_Y39_N10
\SheRa|S_g\ : cycloneiv_lcell_comb
-- Equation(s):
-- \SheRa|S_g~combout\ = LCELL((!\KEY[3]~input_o\) # (!\HeMan|Qa~combout\))
...
PORT MAP (
	datac => \HeMan|Qa~combout\,
	datad => \KEY[3]~input_o\,
	combout => \SheRa|S_g~combout\);

-- Location: LCCOMB_X116_Y39_N24
\SheRa|R\ : cycloneiv_lcell_comb
-- Equation(s):
-- \SheRa|R~combout\ = LCELL(!\HeMan|Qa~combout\)
...
PORT MAP (
	datac => \HeMan|Qa~combout\,
	combout => \SheRa|R~combout\);

-- Location: LCCOMB_X116_Y39_N0
\SheRa|R_g\ : cycloneiv_lcell_comb
-- Equation(s):
-- \SheRa|R_g~combout\ = LCELL((!\KEY[3]~input_o\) # (!\SheRa|R~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \SheRa|R~combout\,
	datad => \KEY[3]~input_o\,
	combout => \SheRa|R_g~combout\);

-- Location: LCCOMB_X116_Y39_N12
\SheRa|Qb\ : cycloneiv_lcell_comb
-- Equation(s):
-- \SheRa|Qb~combout\ = LCELL((!\SheRa|Qa~combout\) # (!\SheRa|R_g~combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \SheRa|R_g~combout\,
	datad => \SheRa|Qa~combout\,
	combout => \SheRa|Qb~combout\);

-- Location: LCCOMB_X116_Y39_N16
\SheRa|Qa\ : cycloneiv_lcell_comb
-- Equation(s):
-- \SheRa|Qa~combout\ = LCELL((!\SheRa|Qb~combout\) # (!\SheRa|S_g~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \SheRa|S_g~combout\,
	datad => \SheRa|Qb~combout\,
	combout => \SheRa|Qa~combout\);
