...
SIGNAL \BANANA|FA0|FA3|m~0_combout\ : std_logic;
SIGNAL \BANANA|FA0|FA3|m~1_combout\ : std_logic;
SIGNAL \BANANA|FA0|FA3|m~2_combout\ : std_logic;
SIGNAL \BANANA|FA1|FA3|m~0_combout\ : std_logic;
SIGNAL \BANANA|FA1|FA3|m~1_combout\ : std_logic;
SIGNAL \BANANA|FA1|FA3|m~2_combout\ : std_logic;
SIGNAL \BANANA|FA2|FA3|m~0_combout\ : std_logic;
SIGNAL \BANANA|FA2|FA3|m~1_combout\ : std_logic;
SIGNAL \BANANA|FA2|FA3|m~2_combout\ : std_logic;
...
\BANANA|FA0|FA3|m~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \BANANA|FA0|FA3|m~0_combout\ = (\SW[15]~input_o\ & ((\SW[9]~input_o\) # ((\SW[16]~input_o\)))) # (!\SW[15]~input_o\ & (((\SW[12]~input_o\ & !\SW[16]~input_o\))))
...
PORT MAP (
	...
	datac => \SW[15]~input_o\,
	datad => \SW[16]~input_o\,
	combout => \BANANA|FA0|FA3|m~0_combout\);

-- Location: LCCOMB_X116_Y51_N2
\BANANA|FA0|FA3|m~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \BANANA|FA0|FA3|m~1_combout\ = (\BANANA|FA0|FA3|m~0_combout\ & ((\SW[3]~input_o\) # ((!\SW[16]~input_o\)))) # (!\BANANA|FA0|FA3|m~0_combout\ & (((\SW[6]~input_o\ & \SW[16]~input_o\))))
...
PORT MAP (
	dataa => \SW[3]~input_o\,
	datab => \BANANA|FA0|FA3|m~0_combout\,
	datac => \SW[6]~input_o\,
	datad => \SW[16]~input_o\,
	combout => \BANANA|FA0|FA3|m~1_combout\);

-- Location: LCCOMB_X116_Y51_N4
\BANANA|FA0|FA3|m~2\ : cycloneiv_lcell_comb
-- Equation(s):
-- \BANANA|FA0|FA3|m~2_combout\ = (\SW[17]~input_o\ & ((\SW[0]~input_o\))) # (!\SW[17]~input_o\ & (\BANANA|FA0|FA3|m~1_combout\))
...
-- pragma translate_on
PORT MAP (
	datab => \BANANA|FA0|FA3|m~1_combout\,
	datac => \SW[0]~input_o\,
	datad => \SW[17]~input_o\,
	combout => \BANANA|FA0|FA3|m~2_combout\);

-- Location: LCCOMB_X116_Y51_N6
\BANANA|FA1|FA3|m~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \BANANA|FA1|FA3|m~0_combout\ = (\SW[15]~input_o\ & (((\SW[16]~input_o\)))) # (!\SW[15]~input_o\ & ((\SW[16]~input_o\ & ((\SW[7]~input_o\))) # (!\SW[16]~input_o\ & (\SW[13]~input_o\))))
...
PORT MAP (
	...
	datac => \SW[7]~input_o\,
	datad => \SW[16]~input_o\,
	combout => \BANANA|FA1|FA3|m~0_combout\);

-- Location: LCCOMB_X116_Y51_N0
\BANANA|FA1|FA3|m~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \BANANA|FA1|FA3|m~1_combout\ = (\SW[15]~input_o\ & ((\BANANA|FA1|FA3|m~0_combout\ & (\SW[4]~input_o\)) # (!\BANANA|FA1|FA3|m~0_combout\ & ((\SW[10]~input_o\))))) # (!\SW[15]~input_o\ & (((\BANANA|FA1|FA3|m~0_combout\))))
...
PORT MAP (
	...
	datab => \SW[10]~input_o\,
	datac => \SW[15]~input_o\,
	datad => \BANANA|FA1|FA3|m~0_combout\,
	combout => \BANANA|FA1|FA3|m~1_combout\);

-- Location: LCCOMB_X116_Y51_N26
\BANANA|FA1|FA3|m~2\ : cycloneiv_lcell_comb
-- Equation(s):
-- \BANANA|FA1|FA3|m~2_combout\ = (\SW[17]~input_o\ & ((\SW[1]~input_o\))) # (!\SW[17]~input_o\ & (\BANANA|FA1|FA3|m~1_combout\))
...
PORT MAP (
	dataa => \SW[17]~input_o\,
	datab => \BANANA|FA1|FA3|m~1_combout\,
	datad => \SW[1]~input_o\,
	combout => \BANANA|FA1|FA3|m~2_combout\);

-- Location: LCCOMB_X116_Y51_N12
\BANANA|FA2|FA3|m~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \BANANA|FA2|FA3|m~0_combout\ = (\SW[15]~input_o\ & ((\SW[11]~input_o\) # ((\SW[16]~input_o\)))) # (!\SW[15]~input_o\ & (((\SW[14]~input_o\ & !\SW[16]~input_o\))))
...
PORT MAP (
	...
	datac => \SW[14]~input_o\,
	datad => \SW[16]~input_o\,
	combout => \BANANA|FA2|FA3|m~0_combout\);

-- Location: LCCOMB_X116_Y51_N14
\BANANA|FA2|FA3|m~1\ : cycloneiv_lcell_comb
-- Equation(s):
-- \BANANA|FA2|FA3|m~1_combout\ = (\BANANA|FA2|FA3|m~0_combout\ & (((\SW[5]~input_o\) # (!\SW[16]~input_o\)))) # (!\BANANA|FA2|FA3|m~0_combout\ & (\SW[8]~input_o\ & ((\SW[16]~input_o\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \BANANA|FA2|FA3|m~0_combout\,
	datab => \SW[8]~input_o\,
	datac => \SW[5]~input_o\,
	datad => \SW[16]~input_o\,
	combout => \BANANA|FA2|FA3|m~1_combout\);

-- Location: LCCOMB_X116_Y51_N8
\BANANA|FA2|FA3|m~2\ : cycloneiv_lcell_comb
-- Equation(s):
-- \BANANA|FA2|FA3|m~2_combout\ = (\SW[17]~input_o\ & ((\SW[2]~input_o\))) # (!\SW[17]~input_o\ & (\BANANA|FA2|FA3|m~1_combout\))
...
PORT MAP (
	dataa => \SW[17]~input_o\,
	datab => \BANANA|FA2|FA3|m~1_combout\,
	datad => \SW[2]~input_o\,
	combout => \BANANA|FA2|FA3|m~2_combout\);
