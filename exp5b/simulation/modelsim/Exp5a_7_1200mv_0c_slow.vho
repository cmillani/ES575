...
SIGNAL \Contador|VALUE[0]~22_combout\ : std_logic;
SIGNAL \KEY[0]~input_o\ : std_logic;
SIGNAL \Contador|VALUE[1]~8_combout\ : std_logic;
SIGNAL \Contador|VALUE[1]~9\ : std_logic;
SIGNAL \Contador|VALUE[2]~10_combout\ : std_logic;
SIGNAL \Contador|VALUE[2]~11\ : std_logic;
SIGNAL \Contador|VALUE[3]~12_combout\ : std_logic;
SIGNAL \Contador|VALUE[3]~13\ : std_logic;
SIGNAL \Contador|VALUE[4]~14_combout\ : std_logic;
SIGNAL \Contador|VALUE[4]~15\ : std_logic;
SIGNAL \Contador|VALUE[5]~16_combout\ : std_logic;
SIGNAL \Contador|VALUE[5]~17\ : std_logic;
SIGNAL \Contador|VALUE[6]~18_combout\ : std_logic;
SIGNAL \Contador|VALUE[6]~19\ : std_logic;
SIGNAL \Contador|VALUE[7]~20_combout\ : std_logic;
SIGNAL \Contador|Equal0~1_combout\ : std_logic;
SIGNAL \Contador|Equal0~0_combout\ : std_logic;
SIGNAL \Contador|VALUE[7]~7_combout\ : std_logic;
SIGNAL \Contador|VALUE\ : std_logic_vector(7 DOWNTO 0);
SIGNAL \ALT_INV_KEY[1]~input_o\ : std_logic;
SIGNAL \Contador|ALT_INV_VALUE[7]~7_combout\ : std_logic;
...
\Contador|ALT_INV_VALUE[7]~7_combout\ <= NOT \Contador|VALUE[7]~7_combout\;
...
\Contador|VALUE[0]~22\ : cycloneiv_lcell_comb
-- Equation(s):
-- \Contador|VALUE[0]~22_combout\ = !\Contador|VALUE\(0)
...
-- pragma translate_on
PORT MAP (
	datac => \Contador|VALUE\(0),
	combout => \Contador|VALUE[0]~22_combout\);
...
\Contador|VALUE[1]~8\ : cycloneiv_lcell_comb
-- Equation(s):
-- \Contador|VALUE[1]~8_combout\ = (\Contador|VALUE\(0) & (\Contador|VALUE\(1) $ (VCC))) # (!\Contador|VALUE\(0) & (\Contador|VALUE\(1) & VCC))
-- \Contador|VALUE[1]~9\ = CARRY((\Contador|VALUE\(0) & \Contador|VALUE\(1)))
...
-- pragma translate_on
PORT MAP (
	dataa => \Contador|VALUE\(0),
	datab => \Contador|VALUE\(1),
	datad => VCC,
	combout => \Contador|VALUE[1]~8_combout\,
	cout => \Contador|VALUE[1]~9\);

-- Location: FF_X116_Y30_N1
\Contador|VALUE[1]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	d => \Contador|VALUE[1]~8_combout\,
	clrn => \Contador|ALT_INV_VALUE[7]~7_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \Contador|VALUE\(1));

-- Location: LCCOMB_X116_Y30_N2
\Contador|VALUE[2]~10\ : cycloneiv_lcell_comb
-- Equation(s):
-- \Contador|VALUE[2]~10_combout\ = (\Contador|VALUE\(2) & (!\Contador|VALUE[1]~9\)) # (!\Contador|VALUE\(2) & ((\Contador|VALUE[1]~9\) # (GND)))
-- \Contador|VALUE[2]~11\ = CARRY((!\Contador|VALUE[1]~9\) # (!\Contador|VALUE\(2)))
...
-- pragma translate_on
PORT MAP (
	datab => \Contador|VALUE\(2),
	datad => VCC,
	cin => \Contador|VALUE[1]~9\,
	combout => \Contador|VALUE[2]~10_combout\,
	cout => \Contador|VALUE[2]~11\);

-- Location: FF_X116_Y30_N3
\Contador|VALUE[2]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
\Contador|VALUE[3]~12\ : cycloneiv_lcell_comb
-- Equation(s):
-- \Contador|VALUE[3]~12_combout\ = (\Contador|VALUE\(3) & (\Contador|VALUE[2]~11\ $ (GND))) # (!\Contador|VALUE\(3) & (!\Contador|VALUE[2]~11\ & VCC))
-- \Contador|VALUE[3]~13\ = CARRY((\Contador|VALUE\(3) & !\Contador|VALUE[2]~11\))
...
-- pragma translate_on
PORT MAP (
	datab => \Contador|VALUE\(3),
	datad => VCC,
	cin => \Contador|VALUE[2]~11\,
	combout => \Contador|VALUE[3]~12_combout\,
	cout => \Contador|VALUE[3]~13\);

-- Location: FF_X116_Y30_N5
\Contador|VALUE[3]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
\Contador|VALUE[4]~14\ : cycloneiv_lcell_comb
-- Equation(s):
-- \Contador|VALUE[4]~14_combout\ = (\Contador|VALUE\(4) & (!\Contador|VALUE[3]~13\)) # (!\Contador|VALUE\(4) & ((\Contador|VALUE[3]~13\) # (GND)))
-- \Contador|VALUE[4]~15\ = CARRY((!\Contador|VALUE[3]~13\) # (!\Contador|VALUE\(4)))
...
-- pragma translate_on
PORT MAP (
	dataa => \Contador|VALUE\(4),
	datad => VCC,
	cin => \Contador|VALUE[3]~13\,
	combout => \Contador|VALUE[4]~14_combout\,
	cout => \Contador|VALUE[4]~15\);

-- Location: FF_X116_Y30_N7
\Contador|VALUE[4]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
\Contador|VALUE[5]~16\ : cycloneiv_lcell_comb
-- Equation(s):
-- \Contador|VALUE[5]~16_combout\ = (\Contador|VALUE\(5) & (\Contador|VALUE[4]~15\ $ (GND))) # (!\Contador|VALUE\(5) & (!\Contador|VALUE[4]~15\ & VCC))
-- \Contador|VALUE[5]~17\ = CARRY((\Contador|VALUE\(5) & !\Contador|VALUE[4]~15\))
...
-- pragma translate_on
PORT MAP (
	datab => \Contador|VALUE\(5),
	datad => VCC,
	cin => \Contador|VALUE[4]~15\,
	combout => \Contador|VALUE[5]~16_combout\,
	cout => \Contador|VALUE[5]~17\);

-- Location: FF_X116_Y30_N9
\Contador|VALUE[5]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
\Contador|VALUE[6]~18\ : cycloneiv_lcell_comb
-- Equation(s):
-- \Contador|VALUE[6]~18_combout\ = (\Contador|VALUE\(6) & (!\Contador|VALUE[5]~17\)) # (!\Contador|VALUE\(6) & ((\Contador|VALUE[5]~17\) # (GND)))
-- \Contador|VALUE[6]~19\ = CARRY((!\Contador|VALUE[5]~17\) # (!\Contador|VALUE\(6)))
...
-- pragma translate_on
PORT MAP (
	dataa => \Contador|VALUE\(6),
	datad => VCC,
	cin => \Contador|VALUE[5]~17\,
	combout => \Contador|VALUE[6]~18_combout\,
	cout => \Contador|VALUE[6]~19\);

-- Location: FF_X116_Y30_N11
\Contador|VALUE[6]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
\Contador|VALUE[7]~20\ : cycloneiv_lcell_comb
-- Equation(s):
-- \Contador|VALUE[7]~20_combout\ = \Contador|VALUE\(7) $ (!\Contador|VALUE[6]~19\)
...
-- pragma translate_on
PORT MAP (
	datab => \Contador|VALUE\(7),
	cin => \Contador|VALUE[6]~19\,
	combout => \Contador|VALUE[7]~20_combout\);

-- Location: FF_X116_Y30_N13
\Contador|VALUE[7]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
-- Equation(s):
-- \Contador|Equal0~1_combout\ = (!\Contador|VALUE\(7) & (\Contador|VALUE\(4) & (!\Contador|VALUE\(5) & !\Contador|VALUE\(6))))
...
-- pragma translate_on
PORT MAP (
	dataa => \Contador|VALUE\(7),
	datab => \Contador|VALUE\(4),
	datac => \Contador|VALUE\(5),
	datad => \Contador|VALUE\(6),
	combout => \Contador|Equal0~1_combout\);

-- Location: LCCOMB_X116_Y30_N28
\Contador|Equal0~0\ : cycloneiv_lcell_comb
-- Equation(s):
-- \Contador|Equal0~0_combout\ = (!\Contador|VALUE\(0) & (\Contador|VALUE\(2) & (!\Contador|VALUE\(3) & !\Contador|VALUE\(1))))
...
PORT MAP (
	dataa => \Contador|VALUE\(0),
	datab => \Contador|VALUE\(2),
	datac => \Contador|VALUE\(3),
	datad => \Contador|VALUE\(1),
	combout => \Contador|Equal0~0_combout\);

-- Location: LCCOMB_X116_Y30_N24
\Contador|VALUE[7]~7\ : cycloneiv_lcell_comb
-- Equation(s):
-- \Contador|VALUE[7]~7_combout\ = ((\Contador|Equal0~1_combout\ & \Contador|Equal0~0_combout\)) # (!\KEY[0]~input_o\)
...
PORT MAP (
	dataa => \KEY[0]~input_o\,
	datac => \Contador|Equal0~1_combout\,
	datad => \Contador|Equal0~0_combout\,
	combout => \Contador|VALUE[7]~7_combout\);

-- Location: FF_X116_Y30_N27
\Contador|VALUE[0]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
