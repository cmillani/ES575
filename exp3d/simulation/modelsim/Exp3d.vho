...
ARCHITECTURE structure OF Exp3d IS
...
SIGNAL \EU|Q~combout\ : std_logic;
SIGNAL \VOCE|SheRa|Q~combout\ : std_logic;
SIGNAL \ZOBOOMAFOO|HeMan|Q~combout\ : std_logic;
SIGNAL \ZOBOOMAFOO|SheRa|Q~combout\ : std_logic;
...
\EU|Q\ : cycloneiv_lcell_comb
-- Equation(s):
-- \EU|Q~combout\ = (\KEY[3]~input_o\ & ((\EU|Q~combout\))) # (!\KEY[3]~input_o\ & (\SW[0]~input_o\))
...
PORT MAP (
	...
	datac => \EU|Q~combout\,
	datad => \KEY[3]~input_o\,
	combout => \EU|Q~combout\);

-- Location: LCCOMB_X116_Y8_N30
\VOCE|SheRa|Q\ : cycloneiv_lcell_comb
-- Equation(s):
-- \VOCE|SheRa|Q~combout\ = (\KEY[3]~input_o\ & ((\EU|Q~combout\))) # (!\KEY[3]~input_o\ & (\VOCE|SheRa|Q~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \VOCE|SheRa|Q~combout\,
	datac => \KEY[3]~input_o\,
	datad => \EU|Q~combout\,
	combout => \VOCE|SheRa|Q~combout\);

-- Location: LCCOMB_X116_Y8_N6
\ZOBOOMAFOO|HeMan|Q\ : cycloneiv_lcell_comb
-- Equation(s):
-- \ZOBOOMAFOO|HeMan|Q~combout\ = (\KEY[3]~input_o\ & (\SW[0]~input_o\)) # (!\KEY[3]~input_o\ & ((\ZOBOOMAFOO|HeMan|Q~combout\)))
...
PORT MAP (
	dataa => \SW[0]~input_o\,
	datac => \ZOBOOMAFOO|HeMan|Q~combout\,
	datad => \KEY[3]~input_o\,
	combout => \ZOBOOMAFOO|HeMan|Q~combout\);

-- Location: LCCOMB_X116_Y8_N28
\ZOBOOMAFOO|SheRa|Q\ : cycloneiv_lcell_comb
-- Equation(s):
-- \ZOBOOMAFOO|SheRa|Q~combout\ = (\KEY[3]~input_o\ & (\ZOBOOMAFOO|SheRa|Q~combout\)) # (!\KEY[3]~input_o\ & ((\ZOBOOMAFOO|HeMan|Q~combout\)))
...
-- pragma translate_on
PORT MAP (
	datab => \ZOBOOMAFOO|SheRa|Q~combout\,
	datac => \KEY[3]~input_o\,
	datad => \ZOBOOMAFOO|HeMan|Q~combout\,
	combout => \ZOBOOMAFOO|SheRa|Q~combout\);
